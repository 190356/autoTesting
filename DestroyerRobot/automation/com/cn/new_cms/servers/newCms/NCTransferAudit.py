...
from DestroyerRobot.automation.com.cn.new_cms.servers.MPTree.MPTree import MPTree
...
class NCTransferAudit:
    ...
    def upload_pic(self,bys,values):
        ele = self.page.getElementByElement(bys, values)
        self.page.sendkeys(ele,r"D:\工作\automation\DestroyerRobot\automation\public_img\pic.jpg")
